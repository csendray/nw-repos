...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check filter bar", function (Given, When, Then) {
            Then.onTheCustomersListGenerated.onFilterBar().iCheckFilterField("Country");
            Then.onTheCustomersListGenerated.onFilterBar().iCheckFilterField("City");
        });
        ...
        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheCustomersListGenerated.onTable().iCheckColumns(undefined, {"CustomerID":{"header":"Customer ID"},"CompanyName":{"header":"Company"},"ContactName":{"header":"Contact"},"City":{"header":"City"},"Country":{"header":"Country"},"Phone":{"header":"Phone"}});
